...
public class Area {
    ...
    @Expose
    private GrammaticalCasesRu_ grammaticalCasesRu;
    ...
    public GrammaticalCasesRu_ getGrammaticalCasesRu() {
        return grammaticalCasesRu;
    }

    public void setGrammaticalCasesRu(GrammaticalCasesRu_ grammaticalCasesRu) {
